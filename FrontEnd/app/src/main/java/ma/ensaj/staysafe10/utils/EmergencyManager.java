...
import ma.ensaj.staysafe10.utils.LocationHelper;
import ma.ensaj.staysafe10.utils.SocialShareManager;
import ma.ensaj.staysafe10.utils.TwilioService;
        ...
        LocationHelper.getLocation(context, new LocationHelper.LocationCallback() {
            ...
            public void onLocationReceived(String locationUrl) {
                ...
                for (Contact contact : emergencyContacts) {
                    // Envoyer le SMS avec l'URL de localisation
                    twilioService.sendSMS(contact.getNumber(), message);

                    // Envoyer le message WhatsApp avec l'URL, la date et l'heure
                    twilioService.sendWhatsAppMessage(contact.getNumber(),message, currentDate, currentTime);
                }
